        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-4">
                <div className="text-center mb-6 animate-fade-in">
                    <h1 className="text-3xl lg:text-4xl font-bold mb-3 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                        🎵 Guess the Opening
                    </h1>
                    <p className="text-base text-gray-300 mb-1">Listen to the opening and guess the anime!</p>
    ...
    return (
        <div className="min-h-screen p-3 pb-6">
            ...
            <div className="text-center pt-4 mb-4">
                <h1 className="text-2xl font-bold mb-2">🎵 Guess the Opening</h1>

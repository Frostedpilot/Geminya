...
class DadJokeCog(BaseCommand):
    # Constants
    ERROR_MESSAGE = "Failed to retrieve a dad joke, nya! (｡•́︿•̀｡)"

    def __init__(self, bot: commands.Bot, services: ServiceContainer):
        super().__init__(bot, services)

    @commands.hybrid_command(name="dad_joke", description="Tell a dad joke.")
...
async def setup(bot: commands.Bot):
    ...
    await bot.add_cog(DadJokeCog(bot, bot.services))
